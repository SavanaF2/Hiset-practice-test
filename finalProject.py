'''
To do: Make it centered. Put the question and answers in a frame. Change the frame to red or green once user clicks submit.
...
Give a label at the top indicating which test the user is taking. Add images
...
def test(num):
     ...
     class Quiz:
          ...
          # This method checks the Answer after user clicks Next.
          ...
          def next_btn(self): 
               ...
               self.q_no += 1
               #Makes the previous question, buttons, explanation, and result dissapear after user clicks next so the new ones do not stack ontop of them.
